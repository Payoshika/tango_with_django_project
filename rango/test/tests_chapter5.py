...
class Chapter5AdminInterfaceTests(TestCase):
    ...
    def test_page_display_changes(self):
        ...
        self.assertTrue('<div class="text"><a href="?o=1">Title</a></div>' in response_body, fw"{FAILURE_HEADER}The 'Title' column could not be found in the admin interface for the Page model -- if it is present, is it in the correct order?{FAILURE_FOOTER}")
